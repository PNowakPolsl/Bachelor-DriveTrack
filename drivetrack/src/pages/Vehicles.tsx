...
export default function Vehicles() {
  ...
  const handleUpdateVehicle = (updatedVehicle: any) => {
    ...
    setVehicles(prev => prev.map((v, i) => (i === vehicleToEdit ? { ...v, ...updatedVehicle } as any : v)));
      ...
      <div className="flex flex-col flex-1">
        ...
        <main className="p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => { setIsFormOpen(true); setVehicleToEdit(null); }}
              ...
              >
                ...
                <div className="mt-4 border-t border-gray-100 pt-4">
                  ...
                  <div className="flex justify-between text-gray-800 font-bold">
                    ...
                    <span>— km</span>{/* dodać przebieg z wpisów (fuel/expenses) */}
                  </div>
                </div>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
              <div className="bg-white p-6 rounded-2xl shadow-xl w-full max-w-sm text-center">
                ...
                <div className="flex justify-center gap-4">
                  <button onClick={cancelDelete} className="px-5 py-2 rounded-lg bg-gray-200 text-gray-800 hover:bg-gray-300 transition">
                    Anuluj
                  </button>
                  <button onClick={confirmDelete} className="px-5 py-2 rounded-lg bg-red-600 text-white hover:bg-red-500 transition ">
                    Tak, usuń
                  </button>
                </div>
              </div>
