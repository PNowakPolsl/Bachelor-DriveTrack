...
var Project = /** @class */ (function () {
    ...
    function Project(options, fileSystem) {
        ...
        if (tsConfigParseResult != null && options.addFilesFromTsConfig !== false) {
            var filePaths = utils_1.getFilePathsFromTsConfigParseResult({
                tsConfigFilePath: options.tsConfigFilePath,
     ...
     */
    Project.prototype.addDirectoryIfExists = function (dirPath) {
     ...
     */
    Project.prototype.addExistingDirectory = function (dirPath) {
     ...
     */
    Project.prototype.addSourceFileIfExists = function (filePath) {
    ...
    Project.prototype.createSourceFile = function (filePath, structureOrText) {
