        ...
        if (isDecoratorFactory) {
            ...
            manipulation_1.insertIntoParentTextRange({
                ...
                customMappings: function (newParent) {
                    ...
                    return [{ currentNode: expression_1, newNode: newParent.getCallExpressionOrThrow().getExpression() }];
                }
            });
        }
        else {
            ...
            manipulation_1.insertIntoParentTextRange({
                ...
                customMappings: function (newParent) {
                    ...
                    return [{ currentNode: expression_2, newNode: newParent.getExpression() }];
                }
            });
        }
        return this;
