...
var StringLiteral = /** @class */ (function (_super) {
    ...
    StringLiteral.prototype.setLiteralValue = function (value) {
        manipulation_1.replaceNodeText({
            ...
            newText: utils_1.StringUtils.escapeChar(value, this.getQuoteType()).replace(/(\r?\n)/g, "\\$1")
        });
        return this;
    };
    /**
     * Gets the quote type.
     */
    StringLiteral.prototype.getQuoteType = function () {
        return this.getText()[0] === "'" ? QuoteType_1.QuoteType.Single : QuoteType_1.QuoteType.Double;
    };
