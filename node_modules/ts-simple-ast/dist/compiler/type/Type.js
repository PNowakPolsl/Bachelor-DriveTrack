...
var Type = /** @class */ (function () {
    ...
    Type.prototype.isStringType = function () {
        return (this.compilerType.flags & typescript_1.TypeFlags.String) !== 0;
    };
    /**
     * Gets if this is a number type.
     */
    Type.prototype.isNumberType = function () {
        return (this.compilerType.flags & typescript_1.TypeFlags.Number) !== 0;
    };
    /**
    ...
    Type.prototype.isNullType = function () {
        return (this.compilerType.flags & typescript_1.TypeFlags.Null) !== 0;
    };
    /**
    ...
    Type.prototype.isTupleType = function () {
        ...
        if (targetType == null)
            return false;
        return (targetType.getObjectFlags() & typescript_1.ObjectFlags.Tuple) !== 0;
    };
    /**
