...
var LanguageService = /** @class */ (function () {
    ...
    function LanguageService(global) {
        ...
        var languageServiceHost = {
            ...
            getDefaultLibFileName: function (options) {
                if (_this.global.fileSystemWrapper.getFileSystem() instanceof fileSystem_1.DefaultFileSystemHost)
                    return typescript_1.ts.getDefaultLibFilePath(global.compilerOptions);
                else
                    return utils_1.FileUtils.pathJoin(global.fileSystemWrapper.getCurrentDirectory(), "node_modules/typescript/lib/" + typescript_1.ts.getDefaultLibFileName(global.compilerOptions));
            },
        ...
        this.compilerHost = {
            getSourceFile: function (fileName, languageVersion, onError) {
                var sourceFile = _this.global.compilerFactory.addOrGetSourceFileFromFilePath(fileName);
    ...
    LanguageService.prototype.getFormattingEditsForRange = function (filePath, range, settings) {
        ...
        return (this.compilerObject.getFormattingEditsForRange(filePath, range[0], range[1], settings) || []).map(function (e) { return new results_1.TextChange(e); });
    };
    /**
    ...
    LanguageService.prototype.getFormattingEditsForDocument = function (filePath, settings) {
        utils_1.fillDefaultFormatCodeSettings(settings, this.global.manipulationSettings);
        return (this.compilerObject.getFormattingEditsForDocument(filePath, settings) || []).map(function (e) { return new results_1.TextChange(e); });
    };
    /**
    ...
    LanguageService.prototype.getFormattedDocumentText = function (filePath, settings) {
        ...
        var newLineChar = settings.newLineCharacter; // this is filled in getFormattingEditsForDocument
