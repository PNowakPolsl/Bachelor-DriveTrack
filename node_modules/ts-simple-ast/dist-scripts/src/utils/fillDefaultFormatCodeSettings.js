...
function fillDefaultFormatCodeSettings(settings, manipulationSettings) {
    ...
    setValueIfUndefined_1.setValueIfUndefined(settings, "insertSpaceAfterSemicolonInForStatements", false);
    setValueIfUndefined_1.setValueIfUndefined(settings, "insertSpaceAfterKeywordsInControlFlowStatements", true);
    setValueIfUndefined_1.setValueIfUndefined(settings, "insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces", false);
