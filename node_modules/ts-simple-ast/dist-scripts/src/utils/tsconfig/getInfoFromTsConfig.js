...
function getFilePathsFromTsConfigParseResult(opts) {
    ...
    var host = {
        ...
        readDirectory: function (rootDir, extensions, excludes, includes) { return tsMatchFiles(rootDir, extensions, excludes || [], includes, false, currentDir, undefined, function (path) { return getFileSystemEntries(path, fileSystemWrapper); }); },
