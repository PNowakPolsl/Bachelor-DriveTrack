import { PropertySignatureStructure, MethodSignatureStructure, ConstructSignatureDeclarationStructure, CallSignatureDeclarationStructure, IndexSignatureDeclarationStructure } from "../interface";
