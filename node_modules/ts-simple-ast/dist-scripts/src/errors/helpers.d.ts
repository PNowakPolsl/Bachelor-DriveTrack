 ...
 */
export declare function throwIfNotSyntaxKind(node: Node, kind: SyntaxKind, message?: string): void;
/**
 ...
 */
export declare function getNotImplementedForSyntaxKindError(kind: SyntaxKind): NotImplementedError;
/**
 * Throws an Argument
 * @param value
 * @param argName
 ...
 */
export declare function throwIfFileNotExists(fileSystemWrapper: FileSystemWrapper, filePath: string): void;
