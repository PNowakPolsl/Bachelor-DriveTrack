...
var SourceFile = /** @class */ (function (_super) {
     ...
     * @deprecated
     */
    SourceFile.prototype.getReferencingImportAndExportDeclarations = function () {
        console.warn("getReferencingImportAndExportDeclarations" + " will be replaced with " + "getReferencingNodesInOtherSourceFiles" + " in v10.");
        var nodes = this._referenceContainer.getReferencingNodesInOtherSourceFiles();
        return utils_1.ArrayUtils.from(filterNodes());
        function filterNodes() {
            var nodes_1, nodes_1_1, node, e_2_1, e_2, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(utils_1.TypeGuards.isImportDeclaration(node) || utils_1.TypeGuards.isExportDeclaration(node))) return [3 /*break*/, 3];
                        return [4 /*yield*/, node];
                    case 2:
                        _b.sent();
                        _b.label = 3;
    ...
    SourceFile.prototype.getExportedDeclarations = function () {
        ...
        function getDeclarationsForSymbols() {
            function getDeclarationHandlingExportSpecifiers(declaration) {
                var _a, _b, d, e_3_1, identifier, symbol, _c, _d, d, e_4_1, e_3, _e, e_4, _f;
            ...
            var handledDeclarations, exportSymbols_1, exportSymbols_1_1, symbol, _a, _b, declaration, e_5_1, e_6_1, e_6, _c, e_5, _d;
