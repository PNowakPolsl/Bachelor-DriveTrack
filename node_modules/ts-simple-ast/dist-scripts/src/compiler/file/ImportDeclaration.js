...
var ImportDeclaration = /** @class */ (function (_super) {
    ...
    ImportDeclaration.prototype.setModuleSpecifier = function (textOrSourceFile) {
        ...
        this.getLastChildByKindOrThrow(typescript_1.SyntaxKind.StringLiteral).setLiteralValue(text);
        return this;
    };
    /**
    ...
    ImportDeclaration.prototype.isModuleSpecifierRelative = function () {
        return utils_1.ModuleUtils.isModuleSpecifierRelative(this.getModuleSpecifier());
    };
    /**
    ...
    ImportDeclaration.prototype.insertNamedImports = function (index, structuresOrNames) {
        ...
        var codes = structuresOrNames.map(function (s) {
            if (typeof s === "string")
                return s;
            var text = s.name;
