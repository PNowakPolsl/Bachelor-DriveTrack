...
function replaceSourceFileForFilePathMove(opts) {
    ...
    var replacementSourceFile = sourceFile.global.compilerFactory.createTempSourceFileFromText(sourceFile.getFullText(), { filePath: newFilePath });
    new nodeHandlers_1.NodeHandlerFactory().getForStraightReplacement(sourceFile.global.compilerFactory).handleNode(sourceFile, replacementSourceFile);
}
